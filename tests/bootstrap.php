...
if ( ! defined( 'TENUP_PRIMARY_CATEGORY_DIR' ) ) {
	define( 'TENUP_PRIMARY_CATEGORY_DIR', __DIR__ . '/' );
}
...
if ( ! defined( 'TENUP_PRIMARY_CATEGORY_PATH' ) ) {
	define( 'TENUP_PRIMARY_CATEGORY_PATH', 'path' );
}
...
require_once __DIR__ . '/../tests/phpunit/test-tools/test-case.php';
